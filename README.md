...
Auto-deploys on every push to `main`. The browser polls **live Nasdaq + Yahoo spark** every **5 seconds**. `live.json` is build/debug only — **not** used for the on-screen live feed (`APP_MEMORY.md`).
